...
public class XMLBIFParser {
    ...
    /*
     * given the string of the XML/BIF file, creates and returns a BayesianNetwork
     */
    public BayesianNetwork createBayesianNetwork(String s){
    	BayesianNetwork network = null;
    	try {
			network = readNetworkFromFile(s);
			return network;
		} catch (Exception e) {
			System.out.println("Could not create BayesianNetwork.");
			e.printStackTrace();
		}
		return network; 
    }
